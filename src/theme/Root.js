...
// ⚠️ 必须渲染原始 @theme-init/Root：它会提供 ColorModeProvider /
// ScrollControllerProvider / I18nProvider 等全局 context。
// 若不包裹，SSG 时 useColorMode / useScrollController 会抛 ReactContextError，
// 导致所有 blog/docs 页面构建失败（dev 下整棵 React 树也会塌掉）。
