            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <form onSubmit={handleEmailLogin} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        ...
                        <button type="submit" disabled={loading} style={{ padding: '12px', background: '#4285f4', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '14px', cursor: loading ? 'not-allowed' : 'pointer', opacity: loading ? 0.7 : 1 }}>
                            {loading ? '登录中...' : '邮箱登录'}
                        </button>
                    </form>
                    ...
                    <button onClick={handleGithubLogin} disabled={loading} style={{ width: '100%', padding: '12px', background: '#333', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '14px', cursor: loading ? 'not-allowed' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', opacity: loading ? 0.7 : 1 }}>
                    ...
                    <div style={{ textAlign: 'center', marginTop: '24px', fontSize: '14px', color: '#666' }}>
                        还没有账号？<button onClick={() => window.location.href = '/pblot/register'} style={{ background: 'none', border: 'none', color: '#4285f4', cursor: 'pointer' }}>立即注册</button>
                    </div>
                </div>
            </div>
        </Layout>
