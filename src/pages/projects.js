            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ textAlign: "center", marginBottom: "30px" }}>
                        <h1 style={{ fontSize: "32px", color: "var(--ifm-text-color)", margin: 0 }}>🚀 开源项目</h1>
                        <p style={{ color: "var(--ifm-color-emphasis-600)", marginTop: "10px" }}>开放共享 · 共同进步 · 持续迭代</p>
                    </div>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: "25px" }}>
                        {projects.map((item, index) => (
                            ...
                            >
                                <h3 style={{ margin: "0 0 10px 0", color: "var(--ifm-text-color)", fontSize: "19px" }}>{item.name}</h3>
                                <p style={{ color: "var(--ifm-color-emphasis-600)", lineHeight: "1.7", fontSize: "14px", minHeight: "45px" }}>{item.desc}</p>
