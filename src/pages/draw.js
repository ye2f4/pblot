    ...
    return (
        <Layout title="随机抽贴" description="趣味抽贴，随机学习">
            <div style={{
                ...
                <div style={{
                    width: "100%", maxWidth: "600px", background: "var(--ifm-card-background-color)",
                    ...
                    <p style={{ color: "var(--ifm-color-emphasis-600)", margin: "0 0 40px 0" }}>
                        点击按钮，随机抽取一篇学习内容
                    </p>
                    ...
                    <div style={{
                        ...
                        fontSize: "16px", color: result ? "var(--ifm-text-color)" : "var(--ifm-color-emphasis-600)"
                    }}>
                        {result || "点击下方按钮开始抽取"}
                    </div>
                    ...
                    <button
                        ...
                        style={{
                            ...
                            background: rolling ? "var(--ifm-color-emphasis-300)" : "#4285f4", color: "#fff",
